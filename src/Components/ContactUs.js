                ...
                <ContactUsContainer>
                    <ContactUsWrapper>
                        <ContactUsInfoWrapper>
                            ...
                            <StatementCard stretched="80" StatementTitle="artmuseum@info.com" icon={<GrMail style={{width: '30px', height: '30px', color: 'black'}}/>}/>
                            <StatementCard  fadedaway="#a5a6a6" stretched="80" StatementTitle="38 North Lafayette Drive"
